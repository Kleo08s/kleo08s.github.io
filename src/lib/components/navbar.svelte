...
<div class="navbar-main">
    ...
    <div class="end">
        <Popover.Root open={false}> <!-- * Remove after production -->
            ...
            <Popover.Content class="w-130 rounded-[16px]" >
